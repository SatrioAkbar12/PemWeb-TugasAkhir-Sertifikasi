...
@section('content')
    ...
    <section class="content-header">
        ...
        <div class="row mb-2">
            <div class="col-sm-6">
                <h4> Kompetensi : {{ $data->refUnitKompetensi->nama }}</h4>
            </div>
        </div>
        </div><!-- /.container-fluid -->
    </section>
                    ...
                    @foreach ($data_instrumenasesmen as $d)
                        <div class="row p-1">
                            ...
                            <div class="form-group">
                                <input id="input_jawaban" class="form-control" name="jawaban_self_asesmen" type="text" value="{{ $data->jawaban_self_asesmen }}" placeholder="Masukkan Jawaban..." required />
                            </div>
                            <div class="form-group">
                                <input id="input_path_bukti" class="form-control" name="path_bukti" type="text" value="{{ $data->path_bukti }}" placeholder="Masukkan Bukti..." required />
                            </div>
                        </div>
                    @endforeach
                    <div class="form-group">
