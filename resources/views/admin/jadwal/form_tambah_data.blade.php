...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Tambah Data Jadwal Sertifikasi</h1>
                </div>
            </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body p-4">
                <form method="post" action="/admin/jadwal/tambah">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="form-group">
                        <label for="input_penawaranSertifikasi" class="form-label">Penawaran Sertifikasi</label>
                        <select id="input_penawaranSertifikasi" class="form-control" name="penawaranSertifikasi" required>
                            @foreach ($data_penawaransertifikasi as $d_penawaransertifikasi)
                                <option value="{{ $d_penawaransertifikasi->id }}">{{ $d_penawaransertifikasi->nama }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <select id="input_kegiatan" class="form-control" name="kegiatan" required>
                                    @foreach ($data_refkegiatan as $d_refkegiatan)
                                        <option value="{{ $d_refkegiatan->id }}">{{ $d_refkegiatan->nama_kegiatan }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="input_deskripsi" class="form-control" name="deskripsi" placeholder="Masukkan deskripsi ..." required></textarea>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-5 col-md-4">
                                <label for="input_tanggalAwal" class="form-label">Tanggal Awal</label>
                                <input id="input_tanggalAwal" class="form-control" name="tanggalAwal" type="date" required />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-5 col-md-4">
                                ...
                                <input id="input_tanggalAkhir" class="form-control" name="tanggalAkhir" type="date" required />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
