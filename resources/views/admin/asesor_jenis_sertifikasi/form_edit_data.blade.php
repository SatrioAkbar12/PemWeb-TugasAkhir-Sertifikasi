...
@section('head_title', 'Kelola Jenis Sertifikasi Asesor')
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Edit Data Jenis Sertifikasi Asesor</h1>
                </div>
            </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body p-4">
                <form method="post" action="/admin/asesor-jenis-sertifikasi/{{ $data->id }}/edit">
                    {{ method_field('PUT') }}
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="form-group">
                        <label for="input_username" class="form-label">Username</label>
                        <input id="input_username" class="form-control" name="username" type="text" value="{{ $data->asesor->user->username }}" placeholder="Username ..." readonly required/>
                    </div>
                    {{-- <div class="form-group">
                        <label for="input_email" class="form-label">Email</label>
                        <input id="input_email" class="form-control" name="email" type="email" value="{{ $data->user->email }}" placeholder="Email ..." required/>
                    </div> --}}
                    <div class="form-group">
                        <label for="input_nama" class="form-label">Nama Lengkap</label>
                        <input id="input_nama" class="form-control" name="nama" type="text" value="{{ $data->asesor->nama }}" placeholder="Masukkan nama lengkap ..." readonly required/>
                    </div>
                    {{-- <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input id="input_nosertifikat" class="form-control" name="noSertifikat" type="text" value="{{ $data->no_sertifikat }}" placeholder="Masukkan nomor sertifikat ..." required />
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-4">
                                <label for="input_tanggalawalberlaku" class="form-label">Tanggal Awal Berlaku</label>
                                <input id="input_tanggalawalberlaku" class="form-control" name="tanggalAwalBerlaku" type="date" value="{{ $data->tanggal_awal_berlaku }}" required />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-4">
                                ...
                                <input id="input_tanggalakhirberlaku" class="form-control" name="tanggalAkhirBerlaku" type="date" value="{{ $data->tanggal_akhir_berlaku }}" required />
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <a href="/admin/asesor-jenis-sertifikasi"><button class="btn btn-danger" type="button">Kembali</button></a>
                    </div>
                </form>
            </div>
        </div>
