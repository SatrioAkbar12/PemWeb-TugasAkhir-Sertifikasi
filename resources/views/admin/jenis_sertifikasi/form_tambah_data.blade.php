...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Tambah Data Jenis Sertifikasi</h1>
                </div>
            </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body p-4">
                <form method="post" action="/admin/jenis-sertifikasi/tambah">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="form-group">
                        <label for="input_nama" class="form-label">Jenis Sertifikasi</label>
                        <input id="input_nama" class="form-control" name="nama" type="text" placeholder="Masukkan jenis sertifikasi ..." required/>
                    </div>
                    <div class="form-group">
                        <label for="input_keterangan" class="form-label">Keterangan</label>
                        <input type="input_keterangan" class="form-control" name="keterangan" type="text" placeholder="Masukkan keterangan ..." required/>
                    </div>
                    <div class="form-group">
                        <label for="input_statusJenisSertifikasi" class="form-label">Status Jenis Sertifikasi</label>
                        <input type="input_statusJenisSertifikasi" class="form-control" name="statusJenisSertifikasi" type="text" placeholder="Masukkan status ..." required/>
                    </div>
                    <div class="form-group">
