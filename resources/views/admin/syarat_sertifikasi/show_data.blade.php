...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Detail Data Syarat Sertifikasi</h1>
                </div>
            </div>
    </section>
        ...
        <div class="card">
            <div class="card-body p-0">
                                ...
                                @foreach ($data_kompetensi as $d)
                                    <div class="row p-1">
                                        ...
                                        <div class="col-3 text-right">
                                            <a href="/admin/syarat-sertifikasi/{{ $d->id }}/edit">
                                                <button class="btn btn-info" type="button">Edit</button>
                                            </a>
                                            <a href="/admin/syarat-sertifikasi/{{ $d->id }}/delete">
                ...
                <div class="p-4">
                    ...
                    <a href="/admin/syarat-sertifikasi">
