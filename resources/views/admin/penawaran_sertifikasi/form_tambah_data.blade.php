...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Tambah Data Penawaran Sertifikasi</h1>
                </div>
            </div>
    </section>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-body p-4">
                <form method="post" action="/admin/penawaran-sertifikasi/tambah">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="form-group">
                        <label for="input_nama" class="form-label">Nama Sertifikasi</label>
                        <input id="input_nama" class="form-control" name="nama" type="text" placeholder="Masukkan nama sertifikasi ..." required/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="input_periode" class="form-control" name="periode" type="text" placeholder="Masukkan periode ..." required/>
                    </div>
                    <div class="form-group">
